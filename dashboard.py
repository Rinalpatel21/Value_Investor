...
# ---------------------------------------------------
    ...
    trade_log = pd.read_csv("core/data/trade_log.csv")

    paper_orders = pd.read_csv("core/data/paper_orders.csv")
...
# Portfolio Snapshot
    ...
    st.info("Replace this with your real dashboard content (charts, portfolio, trades).")
